...
def main():
    ...
    line = bytes("Burning 'em, if you ain't quick and nimble\nI go crazy when I hear a cymbal", encoding="ascii")
    key = b"ICE"
    
    line_encoded = xor_buffer_with_repeated_key(line, key).hex()
    print(f"line: {line_encoded}")
